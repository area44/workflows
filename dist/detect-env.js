...
import * as a from "fs";
import o, { constants as s, promises as c } from "fs";
...
function _(e, n) {
  ...
  a.appendFileSync(r, `${d(n)}${t.EOL}`, { encoding: `utf8` });
}
function v(e, n) {
...
`,
  ...
  S = l((e, t) => {
    ...
    let U = Symbol.for(`undici.error.UND_ERR_PRX_TLS`);
  ...
  w = l((e, t) => {
    let { wellknownHeaderNames: n, headerNameLowerCasedRecord: r } = C();
    var i = class e {
        value = null;
        left = null;
        middle = null;
  ...
  T = l((e, t) => {
    let n = u(`node:assert`),
      { kDestroyed: r, kBodyUsed: i, kListeners: a, kBody: o } = x(),
      ...
      { InvalidArgumentError: h } = S(),
      { headerNameLowerCasedRecord: g } = C(),
      { tree: _ } = w(),
    ...
    function ce(e) {
      return X ? `${e}`.toWellFormed() : f.toUSVString(e);
    }
    function le(e) {
  ...
  D = l((e, t) => {
    let { InvalidArgumentError: n, NotSupportedError: r } = S(),
      i = u(`node:assert`),
      {
        isValidHTTPToken: a,
      ...
      { channels: v } = E(),
      { headerNameLowerCasedRecord: y } = C(),
      b = /[^\u0021-\u00ff]/,
      x = Symbol(`handler`);
    var w = class {
      constructor(
  ...
  k = l((e, t) => {
    let n = O(),
      { ClientDestroyedError: r, ClientClosedError: i, InvalidArgumentError: a } = S(),
      { kDestroy: o, kClose: s, kClosed: c, kDestroyed: l, kDispatch: u, kInterceptors: d } = x(),
  ...
  j = l((e, t) => {
    let n = u(`node:net`),
      r = u(`node:assert`),
      i = T(),
      { InvalidArgumentError: a, ConnectTimeoutError: o } = S(),
      s = A();
    function c() {}
    let l, d;
    d =
  ...
  B = l((e, t) => {
    let { Transform: n } = u(`node:stream`),
      r = u(`node:zlib`),
      { redirectStatusSet: i, referrerPolicySet: a, badPortsSet: o } = I(),
      { getGlobalOrigin: s } = L(),
      {
    ...
    function w(e, t) {
      ...
      return (
        n !== null && N(n) && (E(n) || (n = D(n)), (n = new URL(n, C(e)))),
        n && !n.hash && (n.hash = t),
        n
      );
    }
...
`) ||
    ...
    let Q = Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]()));
  ...
  te = l((e, t) => {
    let { isBlobLike: n, iteratorMixin: r } = B(),
      { kState: i } = ee(),
      { kEnumerableProperty: a } = T(),
      { FileLike: o, isFileLike: s } = V(),
      { webidl: c } = z(),
  ...
  H = l((e, t) => {
    let { isUSVString: n, bufferToLowerCasedHeaderName: r } = T(),
      { utf8DecodeBytes: i } = B(),
      { HTTP_TOKEN_CODEPOINTS: a, isomorphicDecode: o } = R(),
      { isFileLike: s } = V(),
      { makeEntry: c } = te(),
      l = u(`node:assert`),
...
`);
    ...
    function y(e, t) {
      ...
      for (d !== e.length && (e = e.subarray(0, d)); ; ) {
        ...
        if (
          (u.position === e.length - 2 && w(e, h, u)) ||
          (u.position === e.length - 4 && w(e, g, u))
        )
          return o;
      ...
      for (;;) {
        ...
        switch ((t.position++, S((e) => e === 32 || e === 9, e, t), r(l))) {
          case `content-disposition`:
            if (((n = i = null), !w(e, p, t) || ((t.position += 17), (n = x(e, t)), n === null)))
              return `failure`;
            if (w(e, m, t)) {
...
`,
  ...
  ne = l((e, t) => {
    let n = T(),
      ...
      { serializeAMimeType: b } = R(),
      { multipartFormDataParser: x } = H(),
      S;
    try {
      let e = u(`node:crypto`);
      S = (t) => e.randomInt(0, t);
...
Content-Type: ${c.type || `application/octet-stream`}\r\n\r\n`,
  ...
  U = l((e, t) => {
    let n = u(`node:assert`),
      ...
      ue;
    async function de() {
      let e = process.env.JEST_WORKER_ID ? P() : void 0,
        t;
      try {
        t = await WebAssembly.compile(F());
      } catch {
        t = await WebAssembly.compile(e || P());
      }
      return await WebAssembly.instantiate(t, {
        env: {
          ...
          wasm_on_headers_complete: (e, t, r, i) => (
            n(Q.ptr === e), Q.onHeadersComplete(t, !!r, !!i) || 0
          ),
          wasm_on_body: (e, t, r) => {
            n(Q.ptr === e);
            let i = t - he + $.byteOffset;
    ...
    var ge = class {
      ...
      execute(e) {
        ...
        (e.length > me &&
          (he && i.free(he), (me = Math.ceil(e.length / 4096) * 4096), (he = i.malloc(me))),
      ...
      onHeadersComplete(e, t, i) {
        ...
        if (l.method === `CONNECT` || t) return (n(a[w] === 1), (this.upgrade = !0), 2);
        if (
        ...
        return l.aborted
          ...
          : l.method === `HEAD` || e < 200
            ? 1
            : (o[C] && ((o[C] = !1), a[Y]()), u ? X.ERROR.PAUSED : 0);
      }
      onBody(e) {
      ...
      onMessageComplete() {
        ...
        if (
          ...
          if ((d.onComplete(o), (e[j][e[z]++] = null), t[k]))
            return (n(e[w] === 0), r.destroy(t, new p(`reset`)), X.ERROR.PAUSED);
          if (!u || (t[v] && e[w] === 0)) return (r.destroy(t, new p(`reset`)), X.ERROR.PAUSED);
          e[ee] == null || e[ee] === 1 ? setImmediate(() => e[Y]()) : e[Y]();
        }
      }
    };
    function _e(e) {
      ...
      i === 3
        ? (!t[k] || t.writableNeedDrain || a[w] > 1) &&
          (n(!o, `cannot be paused while waiting for headers`), r.destroy(t, new l()))
        : i === 5
          ? o || r.destroy(t, new m())
          : i === 8 && (n(a[w] === 0 && a[te]), r.destroy(t, new p(`socket idle timeout`)));
    }
      ...
      ((e[V] = t),
        ...
        le(t, `close`, function () {
          ...
          if (((e[V] = null), (e[oe] = null), e.destroyed)) {
            n(e[D] === 0);
            let t = e[j].splice(e[z]);
            for (let n = 0; n < t.length; n++) {
              let a = t[n];
              r.errorRequest(e, a, i);
            }
          } else if (e[w] > 0 && i.code !== `UND_ERR_INFO`) {
            let t = e[j][e[z]];
            ((e[j][e[z]++] = null), r.errorRequest(e, t, i));
          }
          ((e[R] = e[z]), n(e[w] === 0), e.emit(`disconnect`, e[_], [e], i), e[Y]());
        }));
      let i = !1;
      return (
        t.on(`close`, () => {
        ...
        }),
        {
          ...
          busy(n) {
            return !!(
              ...
              (n &&
                ((e[w] > 0 && !n.idempotent) ||
                  (e[w] > 0 && (n.upgrade || n.method === `CONNECT`)) ||
                  (e[w] > 0 &&
    ...
    function ye(e) {
      ...
      if (t && !t.destroyed) {
        if (
          (e[O] === 0
            ? !t[M] && t.unref && (t.unref(), (t[M] = !0))
            : t[M] && t.ref && (t.ref(), (t[M] = !1)),
          e[O] === 0)
        )
          t[b].timeoutType !== 8 && t[b].setTimeout(e[te], 8);
        else if (e[w] > 0 && t[b].statusCode < 200 && t[b].timeoutType !== 3) {
          let n = e[j][e[z]],
...
`),
    ...
    function Se(e, t, i, a, o, s, l, u) {
      n(s !== 0 || i[w] === 0, `stream body cannot be pipelined`);
      let d = !1,
        f = new Ee({
          abort: e,
          socket: o,
    ...
    async function Te(e, t, r, i, a, o, s, c) {
      n(o !== 0 || r[w] === 0, `iterator body cannot be pipelined`);
      let l = null;
      function u() {
        if (l) {
          let e = l;
    ...
    var Ee = class {
      ...
      write(e) {
        ...
        if ((s.onRequestSent(), (e[k] = !1), e[B])) throw e[B];
        if (!e.destroyed) {
          if (
            (r === 0
              ? i
...
`,
      ...
      destroy(e) {
        ...
        ((t[k] = !1), e && (n(r[w] <= 1, `pipeline should only contain this request`), i(e)));
      }
    };
    t.exports = ve;
  }),
  re = l((e, t) => {
    ...
    async function V(e, t) {
      ...
      let r = N.connect(e[l], { createConnection: () => t, peerMaxConcurrentStreams: e[w] });
      ((r[A] = 0),
        (r[f] = e),
        (r[y] = t),
        i.addListener(r, `error`, H),
        i.addListener(r, `frameError`, U),
    ...
    function te(e) {
      let t = e[y];
      t?.destroyed === !1 &&
        (e[O] === 0 && e[w] === 0 ? (t.unref(), e[E].unref()) : (t.ref(), e[E].ref()));
    }
    function H(e) {
    ...
    function G(e, t) {
      ...
      for (let e = 0; e < v.length; e += 2) {
        let t = v[e + 0],
          n = v[e + 1];
        if (Array.isArray(n))
          for (let e = 0; e < n.length; e++) S[t] ? (S[t] += `,${n[e]}`) : (S[t] = n[e]);
        else S[t] = n;
      }
      let C,
      ...
      if (s === `CONNECT`)
        return (
          r.ref(),
          (C = r.request(S, { endStream: !1, signal: m })),
          C.id && !C.pending
      ...
      return (
        p
          ? ((S[z] = `100-continue`),
            (C = r.request(S, { endStream: N, signal: m })),
            C.once(`continue`, V))
          : ((C = r.request(S, { endStream: N, signal: m })), V()),
        ++r[A],
        C.once(`response`, (n) => {
          let { [B]: r, ...a } = n;
      ...
      function V() {
        !x || M === 0
          ? K(O, C, null, e, t, e[y], M, k)
          : i.isBuffer(x)
            ? K(O, C, x, e, t, e[y], M, k)
            : i.isBlobLike(x)
              ? typeof x.stream == `function`
                ? J(O, C, x.stream(), e, t, e[y], M, k)
                : ae(O, C, x, e, t, e[y], M, k)
              : i.isStream(x)
                ? q(O, e[y], k, C, x, e, t, M)
                : i.isIterable(x)
                  ? J(O, C, x, e, t, e[y], M, k)
  ...
  G = l((e, t) => {
    let n = u(`node:assert`),
      ...
      s = D(),
      c = k(),
      { InvalidArgumentError: l, InformationalError: d, ClientDestroyedError: f } = S(),
      p = j(),
      {
        kUrl: m,
        kServerName: h,
    ...
    var ge = class extends c {
      constructor(
        e,
        {
          ...
          maxRedirections: D,
          connect: k,
          maxRequestsPerClient: A,
          localAddress: j,
          maxResponseSize: M,
          autoSelectFamily: R,
          autoSelectFamilyAttemptTimeout: U,
          maxConcurrentStreams: re,
          allowH2: ie,
        } = {},
      ) {
        ...
        if (re != null && (typeof re != `number` || re < 1))
        ...
        (typeof k != `function` &&
          (k = p({
            ...
            socketPath: S,
            timeout: u,
            ...(R ? { autoSelectFamily: R, autoSelectFamilyAttemptTimeout: U } : void 0),
            ...k,
          })),
      ...
      get [A]() {
        return !!this[Z] && !this[M] && !this[Z].destroyed;
      }
      get [_]() {
        return !!(this[Z]?.busy(null) || this[w] >= (he(this) || 1) || this[C] > 0);
      }
      [v](e) {
        ...
        return (
          ...
          this[y] ||
            (a.bodyLength(n.body) == null && a.isIterable(n.body)
              ...
              : this[de](!0)),
          this[y] && this[N] !== 2 && this[_] && (this[N] = 2),
          this[N] < 2
        );
      }
      async [J]() {
        return new Promise((e) => {
          this[w] ? (this[$] = e) : e(null);
        });
      }
      async [Y](e) {
        return new Promise((t) => {
          let n = this[O].splice(this[I]);
    ...
    async function ye(e) {
      ...
      try {
        let r = await new Promise((n, r) => {
          e[G](
            { host: t, hostname: i, protocol: s, port: c, servername: e[h], localAddress: e[se] },
            (e, t) => {
              e ? r(e) : n(t);
            },
          );
        ...
        if (
          ...
          for (n(e[b] === 0); e[C] > 0 && e[O][e[I]].servername === e[h]; ) {
            let t = e[O][e[I]++];
    ...
    function xe(e, t) {
      e[y] !== 2 &&
        ...
        Se(e, t),
        (e[y] = 0),
        e[L] > 256 && (e[O].splice(0, e[L]), (e[I] -= e[L]), (e[L] = 0)));
    }
    function Se(e, t) {
      for (;;) {
        if (e.destroyed) {
        ...
        if ((e[Z] && e[Z].resume(), e[_])) e[N] = 2;
        else if (e[N] === 2) {
          t ? ((e[N] = 1), queueMicrotask(() => be(e))) : be(e);
          continue;
        }
        if (e[C] === 0 || e[b] >= (he(e) || 1)) return;
        let r = e[O][e[I]];
        if (e[m].protocol === `https:` && e[h] !== r.servername) {
          if (e[b] > 0) return;
          ((e[h] = r.servername),
            e[Z]?.destroy(new d(`servername changed`), () => {
              ((e[Z] = null), xe(e));
            }));
        }
        if (e[M]) return;
        ...
        !r.aborted && e[Z].write(r) ? e[I]++ : e[O].splice(e[I], 1);
      }
    }
    t.exports = ge;
  }),
  ...
  q = l((e, t) => {
    let { kFree: n, kConnected: r, kPending: i, kQueued: a, kRunning: o, kSize: s } = x(),
      c = Symbol(`pool`);
    t.exports = class {
      constructor(e) {
        this[c] = e;
        ...
        constructor() {
          ...
          ((this[b] = function (t, n) {
            ...
            ((this[_] = i),
              ...
              e[y] && r.isEmpty() && Promise.all(e[g].map((e) => e.close())).then(e[y]));
          }),
            (this[S] = (t, n) => {
  ...
  J = l((e, t) => {
    let { PoolBase: n, kClients: r, kNeedDrain: i, kAddClient: a, kGetDispatcher: o } = ae(),
      s = G(),
      { InvalidArgumentError: c } = S(),
      l = T(),
      { kUrl: u, kInterceptors: d } = x(),
      f = j(),
      p = Symbol(`options`),
  ...
  Y = l((e, t) => {
    let { BalancedPoolMissingUpstreamError: n, InvalidArgumentError: r } = S(),
      {
        PoolBase: i,
        kClients: a,
        kNeedDrain: o,
    ...
    t.exports = class extends i {
      ...
      addUpstream(e) {
        ...
        (this[s](n),
          n.on(`connect`, () => {
            n[y] = Math.min(this[b], n[y] + this[C]);
          }),
      ...
      _updateBalancedPoolStats() {
        let e = 0;
        for (let t = 0; t < this[a].length; t++) e = w(this[a][t][y], e);
        this[g] = e;
      }
      removeUpstream(e) {
        let t = p(e).origin,
      ...
      [l]() {
        ...
        for (; e++ < this[a].length; ) {
          ...
          if (
            ...
            this[v] === 0 && ((this[_] = this[_] - this[g]), this[_] <= 0 && (this[_] = this[b])),
            e[y] >= this[_] && !e[o])
          )
            return e;
        }
  ...
  oe = l((e, t) => {
    let { InvalidArgumentError: n } = S(),
      { kClients: r, kRunning: i, kClose: a, kDestroy: o, kDispatch: s, kInterceptors: c } = x(),
      l = k(),
      u = J(),
      d = G(),
      f = T(),
    ...
    t.exports = class extends l {
      constructor({ factory: e = C, maxRedirections: t = 0, connect: i, ...a } = {}) {
        ...
        (i && typeof i != `function` && (i = { ...i }),
          ...
          (this[b].interceptors = a.interceptors ? { ...a.interceptors } : void 0),
          (this[_] = t),
          (this[y] = e),
          (this[r] = new Map()),
          (this[v] = (e, t) => {
  ...
  X = l((e, t) => {
    let { kProxy: n, kClose: r, kDestroy: i, kDispatch: a, kInterceptors: o } = x(),
      { URL: s } = u(`node:url`),
      c = oe(),
      l = J(),
      d = k(),
      { InvalidArgumentError: f, RequestAbortedError: p, SecureProxyConnectionError: m } = S(),
      h = j(),
      g = G(),
      ...
      N = class extends d {
        constructor(e) {
          ...
          let { proxyTunnel: r = !0 } = e,
            i = this.#e(e),
            { href: a, origin: l, port: u, protocol: d, username: g, password: x, hostname: S } = i;
          if (
            ...
            : e.token
              ...
              : g &&
                ...
                (this[y][`proxy-authorization`] =
                  `Basic ${Buffer.from(`${decodeURIComponent(g)}:${decodeURIComponent(x)}`).toString(`base64`)}`);
          let k = h({ ...e.proxyTls });
          ...
          let j = e.factory || A,
            N = (e, t) => {
              ...
              return !this[T] && r === `http:` && this[n].protocol === `http:`
                ? new M(this[n].uri, { headers: this[y], connect: k, factory: j })
                : j(e, t);
            };
          ((this[v] = t(i, { connect: k })),
            (this[_] = new c({
              ...e,
              factory: N,
              connect: async (e, t) => {
                ...
                try {
                  let { socket: r, statusCode: i } = await this[v].connect({
                    ...
                    servername: this[C]?.servername || S,
                  });
                  if (
                    (i !== 200 &&
                      (r.on(`error`, O).destroy(),
  ...
  ce = l((e, t) => {
    let n = u(`node:assert`),
      { kRetryHandlerDefaultRetry: r } = x(),
      { RequestRetryError: i } = S(),
      { isDisturbed: a, parseHeaders: o, parseRangeHeader: s, wrapRequestBody: c } = T();
    function l(e) {
      let t = Date.now();
  ...
  Z = l((e, t) => {
    ...
    t.exports = { Readable: v, chunksDecode: w };
  }),
  ue = l((e, t) => {
    let n = u(`node:assert`),
      { ResponseStatusCodeError: r } = S(),
      { chunksDecode: i } = Z();
    async function a({
      callback: e,
      body: t,
  ...
  de = l((e, t) => {
    let n = u(`node:assert`),
      { Readable: r } = Z(),
      { InvalidArgumentError: i, RequestAbortedError: a } = S(),
      o = T(),
  ...
  fe = l((e, t) => {
    let { addAbortListener: n } = T(),
      { RequestAbortedError: r } = S(),
      i = Symbol(`kListener`),
      a = Symbol(`kSignal`);
    function o(e) {
  ...
  pe = l((e, t) => {
    let n = u(`node:assert`),
      ...
      { InvalidArgumentError: a, InvalidReturnValueError: o } = S(),
      s = T(),
      { getResolveErrorBodyCallback: c } = ue(),
      { AsyncResource: l } = u(`node:async_hooks`),
      { addSignal: d, removeSignal: f } = fe();
  ...
  Q = l((e, t) => {
    let { Readable: n, Duplex: r, PassThrough: i } = u(`node:stream`),
      { InvalidArgumentError: a, InvalidReturnValueError: o, RequestAbortedError: s } = S(),
      c = T(),
      { AsyncResource: l } = u(`node:async_hooks`),
      { addSignal: d, removeSignal: f } = fe(),
      p = u(`node:assert`),
  ...
  $ = l((e, t) => {
    let { InvalidArgumentError: n, SocketError: r } = S(),
      { AsyncResource: i } = u(`node:async_hooks`),
      a = T(),
      { addSignal: o, removeSignal: s } = fe(),
      c = u(`node:assert`);
  ...
  me = l((e, t) => {
    let n = u(`node:assert`),
      ...
      { InvalidArgumentError: i, SocketError: a } = S(),
      o = T(),
      { addSignal: s, removeSignal: c } = fe();
    var l = class extends r {
      constructor(e, t) {
        if (!e || typeof e != `object`) throw new i(`invalid opts`);
        if (typeof t != `function`) throw new i(`invalid callback`);
  ...
  he = l((e, t) => {
    ((t.exports.request = de()),
      (t.exports.stream = pe()),
      (t.exports.pipeline = Q()),
      (t.exports.upgrade = $()),
      (t.exports.connect = me()));
  }),
  ge = l((e, t) => {
    let { UndiciError: n } = S(),
  ...
  ve = l((e, t) => {
    let { MockNotMatchedError: n } = ge(),
      { kDispatches: r, kMockAgent: i, kOriginalDispatch: a, kOrigin: o, kGetNetConnect: s } = _e(),
      { buildURL: c } = T(),
  ...
  ye = l((e, t) => {
    let { getResponseData: n, buildKey: r, addMockDispatch: i } = ve(),
      {
        kDispatches: a,
        kDispatchKey: o,
        kDefaultHeaders: s,
  ...
  we = l((e, t) => {
    let { kClients: n } = x(),
      ...
      p = be(),
      m = xe(),
      { matchValue: h, buildMockOptions: g } = ve(),
      { InvalidArgumentError: _, UndiciError: v } = S(),
      y = O(),
      b = Se(),
      C = Ce();
...
`.trim(),
  ...
  ke = l((e, t) => {
    let n = T(),
      { InvalidArgumentError: r, RequestAbortedError: i } = S(),
      a = Ee();
  ...
  Ae = l((e, t) => {
    let { isIP: n } = u(`node:net`),
      { lookup: r } = u(`node:dns`),
      i = Ee(),
      { InvalidArgumentError: a, InformationalError: o } = S(),
      s = 2 ** 31 - 1;
    var c = class {
        #e = 0;
        #t = 0;
  ...
  je = l((e, t) => {
    let { kConstruct: n } = x(),
      { kEnumerableProperty: r } = T(),
      { iteratorMixin: i, isValidHeaderName: a, isValidHeaderValue: o } = B(),
      { webidl: s } = z(),
      c = u(`node:assert`),
      l = u(`node:util`),
    ...
    let { getHeadersGuard: b, setHeadersGuard: S, getHeadersList: C, setHeadersList: w } = y;
  ...
  Me = l((e, t) => {
    let {
      ...
      { redirectStatusSet: O, nullBodyStatus: k } = I(),
      { kState: A, kHeaders: j } = ee(),
      { webidl: M } = z(),
      { FormData: N } = te(),
      { URLSerializer: P } = R(),
      { kConstruct: F } = x(),
    ...
    (d(U),
      ...
      Object.defineProperties(U, { json: _, redirect: _, error: _ }));
    function re(e) {
      if (e.internalResponse) return q(re(e.internalResponse), e.type);
      let t = W({ ...e, body: null });
    ...
    function K(e, t) {
      return (
        ...
        new Proxy(e, {
          ...
          set(e, n, r) {
            return (L(!(n in t)), (e[n] = r), !0);
          },
        })
      );
    }
    function q(e, t) {
      if (t === `basic`) return K(e, { type: `basic`, headersList: e.headersList });
      if (t === `cors`) return K(e, { type: `cors`, headersList: e.headersList });
      if (t === `opaque`)
        return K(e, {
          type: `opaque`,
      ...
      (M.converters.XMLHttpRequestBodyInit = function (e, t, n) {
        return typeof e == `string`
          ...
          : S(e)
            ...
            : ArrayBuffer.isView(e) || V.isArrayBuffer(e)
  ...
  Pe = l((e, t) => {
    let { extractBody: n, mixinBody: r, cloneBody: i, bodyUnusable: a } = ne(),
      {
        Headers: o,
        fill: s,
        HeadersList: c,
      ...
      { FinalizationRegistry: m } = Ne()(),
      h = T(),
      g = u(`node:util`),
      { isValidHTTPToken: _, sameOrigin: v, environmentSettingsObject: y } = B(),
      {
        forbiddenMethodsSet: b,
      ...
      { kHeaders: N, kSignal: P, kState: F, kDispatcher: L } = ee(),
      { webidl: V } = z(),
      { URLSerializer: te } = R(),
      { kConstruct: H } = x(),
      U = u(`node:assert`),
      {
        ...
        defaultMaxListeners: G,
      } = u(`node:events`),
      K = Symbol(`abortController`),
      q = new m(({ signal: e, abort: t }) => {
    ...
    var oe = class e {
      constructor(t, r = {}) {
        ...
        if (typeof t == `string`) {
          ...
          ((u = X({ urlList: [e] })), (d = `cors`));
        } else ((this[L] = r.dispatcher || t[L]), U(t instanceof e), (u = t[F]), (g = t[P]));
        let x = y.settingsObject.origin,
          C = `client`;
        if (
        ...
        if (
          ...
          if (e === ``) u.referrer = `no-referrer`;
            ...
            (x && !v(t, y.settingsObject.baseUrl))
              ? (u.referrer = `client`)
              : (u.referrer = t);
          }
        }
        ...
        if (((this[P] = E.signal), g != null)) {
          ...
          if (g.aborted) E.abort(g.reason);
            ...
            try {
              ((typeof re == `function` && re(g) === G) || ie(g, `abort`).length >= G) &&
                W(1500, g);
            } catch {}
            (h.addAbortListener(g, e), q.register(E, { signal: g, abort: e }, e));
          }
        }
        if (
          ((this[N] = new o(H)), f(this[N], u.headersList), l(this[N], `request`), T === `no-cors`)
        ) {
      ...
      clone() {
        ...
        if (this.signal.aborted) n.abort(this.signal.reason);
          ...
          e === void 0 && ((e = new Set()), ae.set(this.signal, e));
          let t = new WeakRef(n);
          (e.add(t), h.addAbortListener(n.signal, J(t)));
        }
        return ce(t, n.signal, d(this[N]));
      }
      [g.inspect.custom](e, t) {
        (t.depth === null && (t.depth = 2), (t.colors ??= !0));
        let n = {
    ...
    (Object.defineProperties(oe.prototype, {
      ...
      (V.converters.Request = V.interfaceConverter(oe)),
      ...
      (V.converters.RequestInit = V.dictionaryConverter([
        ...
        { key: `referrerPolicy`, converter: V.converters.DOMString, allowedValues: C },
        ...
        { key: `redirect`, converter: V.converters.DOMString, allowedValues: w },
      ...
      (t.exports = { Request: oe, makeRequest: X, fromInnerRequest: ce, cloneRequest: se }));
  }),
  Fe = l((e, t) => {
    let {
        makeNetworkError: n,
      ...
      { kState: q, kDispatcher: ae } = ee(),
      J = u(`node:assert`),
      { safelyExtractBody: Y, extractBody: oe } = ne(),
      {
        redirectStatusSet: X,
        nullBodyStatus: se,
        safeMethodsSet: ce,
      ...
      ue = u(`node:events`),
      { Readable: de, pipeline: fe, finished: pe } = u(`node:stream`),
      { addAbortListener: Q, isErrored: $, isReadable: me, bufferToLowerCasedHeaderName: he } = T(),
      { dataURLProcessor: ge, serializeAMimeType: _e, minimizeSupportedMimeType: ve } = R(),
      { getGlobalDispatcher: ye } = Te(),
      { webidl: be } = z(),
      { STATUS_CODES: xe } = u(`node:http`),
      Se = [`GET`, `HEAD`],
      Ce = typeof __UNDICI_IS_NODE__ < `u` || typeof esbuildDetection < `u` ? `node` : `undici`,
      we;
    ...
    function Oe(e, t = void 0) {
      ...
      let i = r[q];
      if (r.signal.aborted) return (Ne(n, i, null, r.signal.reason), n.promise);
      ...
      return (
        ...
        (l = Fe({
          ...
          processResponse: (e) => {
            if (!s) {
              if (e.aborted) {
                Ne(n, i, a, l.serializedAbortReason);
                return;
              }
              if (e.type === `error`) {
    ...
    function ke(e, t = `other`) {
      ...
      H(n) &&
        ...
        (r.endTime = O()),
        (e.timingInfo = r),
        Ae(r, n.href, t, globalThis, i));
    }
    let Ae = performance.markResourceTiming;
    function Ne(e, t, n, r) {
      if (
        (e && e.reject(r),
        t.body != null &&
    ...
    async function Ie(e, t = !1) {
      let r = e.request,
        a = null;
      if (
        (r.localURLsOnly && !te(y(r)) && (a = n(`local URLs only`)),
        x(r),
      ...
      if (
        ...
        a.type === `opaque` &&
          ...
          (a = o = n()),
        a.status !== 0 &&
          (r.method === `HEAD` || r.method === `CONNECT` || se.includes(o.status)) &&
    ...
    function Le(e) {
      ...
      switch (i) {
        ...
        case `blob:`: {
          we ||= u(`node:buffer`).resolveObjectURL;
          let e = y(t);
          ...
          (e.request.destination === `document` && (e.controller.fullTimingInfo = n),
            (e.controller.reportTimingSteps = () => {
              ...
              e.request.initiatorType != null &&
                Ae(n, e.request.url.href, e.request.initiatorType, globalThis, i, a, o);
            }));
          let i = () => {
            ((e.request.done = !0),
    ...
    function Ve(e, t) {
      ...
      (j(y(r), a) ||
        ...
        r.body != null && (J(r.body.source != null), (r.body = Y(r.body.source)[0])));
      let o = e.timingInfo;
      return (
    ...
    async function He(e, t = !1, i = !1) {
      ...
      if (
        ...
        _(s),
        C(s),
        s.headersList.contains(`user-agent`, !0) || s.headersList.append(`user-agent`, Ce),
        s.cache === `default` &&
    ...
    async function Ue(e, t = !1, i = !1) {
      ...
      ((c.body = { stream: m, source: null, length: null }),
        ...
        (e.controller.resume = async () => {
          for (;;) {
            ...
            if (t === void 0) {
              (L(e.controller.controller), Re(e, c));
              return;
            }
      ...
      function h(t) {
        (N(e)
          ? ((c.aborted = !0),
            me(m) && e.controller.controller.error(e.controller.serializedAbortReason))
          : me(m) &&
            e.controller.controller.error(TypeError(`terminated`, { cause: P(t) ? t : void 0 })),
    ...
    t.exports = { fetch: Oe, Fetch: Ee, fetching: Fe, finalizeAndReportTiming: ke };
  }),
  Ie = l((e, t) => {
    t.exports = {
  ...
  ze = l((e, t) => {
    let { kState: n, kError: r, kResult: i, kAborted: a, kLastProgressEventFired: o } = Ie(),
      { ProgressEvent: s } = Le(),
      { getEncoding: c } = Re(),
      { serializeAMimeType: l, parseMIMEType: d } = R(),
      { types: f } = u(`node:util`),
  ...
  Be = l((e, t) => {
    let { staticPropertyDescriptors: n, readOperation: r, fireAProgressEvent: i } = ze(),
      { kState: a, kError: o, kResult: s, kEvents: c, kAborted: l } = Ie(),
      { webidl: u } = z(),
      { kEnumerableProperty: d } = T();
  ...
  Ve = l((e, t) => {
    t.exports = { kConstruct: x().kConstruct };
  }),
  He = l((e, t) => {
    let n = u(`node:assert`),
      { URLSerializer: r } = R(),
      { isValidHeaderName: i } = B();
    function a(e, t, n = !1) {
      return r(e, n) === r(t, n);
    }
    function o(e) {
  ...
  Ue = l((e, t) => {
    let { kConstruct: n } = Ve(),
      { urlEquals: r, getFieldValues: i } = He(),
      { kEnumerableProperty: a, isDisturbed: o } = T(),
      { webidl: s } = z(),
      { Response: c, cloneResponse: l, fromInnerResponse: d } = Me(),
      { Request: f, fromInnerRequest: p } = Pe(),
      { kState: m } = ee(),
      { fetching: h } = Fe(),
      { urlIsHttpHttpsScheme: g, createDeferredPromise: _, readAllBytes: v } = B(),
      y = u(`node:assert`);
    var b = class e {
      #e;
      constructor() {
  ...
  qe = l((e, t) => {
    let { maxNameValuePairSize: n, maxAttributeValueSize: r } = Ge(),
      { isCTLExcludingHtab: i } = Ke(),
      { collectASequenceOfCodePointsFast: a } = R(),
      o = u(`node:assert`);
    function s(e) {
      if (i(e)) return null;
      let t = ``,
  ...
  Qe = l((e, t) => {
    let { kReadyState: n, kController: r, kResponse: i, kBinaryType: a, kWebSocketURL: o } = Ze(),
      { states: s, opcodes: c } = Xe(),
      { ErrorEvent: l, createFastMessageEvent: d } = Ye(),
      { isUtf8: f } = u(`node:buffer`),
      { collectASequenceOfCodePointsFast: p, removeHTTPWhitespace: m } = R();
    function h(e) {
  ...
  et = l((e, t) => {
    let { uid: n, states: r, sentCloseFrameState: i, emptyBuffer: a, opcodes: o } = Xe(),
      { kReadyState: s, kSentClose: c, kByteParser: l, kReceivedClose: d, kResponse: f } = Ze(),
      {
        fireEvent: p,
      ...
      { makeRequest: x } = Pe(),
      { fetching: S } = Fe(),
      { Headers: C, getHeadersList: w } = je(),
      { getDecodeSplit: T } = B(),
      { WebsocketFrameSend: D } = $e(),
      O;
    try {
      O = u(`node:crypto`);
    } catch {}
  ...
  tt = l((e, t) => {
    let { createInflateRaw: n, Z_DEFAULT_WINDOWBITS: r } = u(`node:zlib`),
      { isValidClientWindowBits: i } = Qe(),
      { MessageSizeExceededError: a } = S(),
  ...
  nt = l((e, t) => {
    let { Writable: n } = u(`node:stream`),
      r = u(`node:assert`),
      { parserStates: i, opcodes: a, states: o, emptyBuffer: s, sentCloseFrameState: c } = Xe(),
      { kReadyState: l, kSentClose: d, kResponse: f, kReceivedClose: p } = Ze(),
      { channels: m } = E(),
      {
        isValidStatusCode: h,
        isValidOpcode: g,
      ...
      { WebsocketFrameSend: C } = $e(),
      { closeWebSocketConnection: w } = et(),
      { PerMessageDeflate: T } = tt();
    t.exports = {
      ByteParser: class extends n {
        ...
        constructor(e, t) {
          (super(),
            (this.ws = e),
            (this.#o = t ?? new Map()),
            this.#o.has(`permessage-deflate`) && this.#o.set(`permessage-deflate`, new T(t)));
        }
        _write(e, t, n) {
  ...
  rt = l((e, t) => {
    let { WebsocketFrameSend: n } = $e(),
      { opcodes: r, sendHints: i } = Xe(),
      a = K(),
  ...
  it = l((e, t) => {
    let { webidl: n } = z(),
      { URLSerializer: r } = R(),
      { environmentSettingsObject: i } = B(),
      { staticPropertyDescriptors: a, states: o, sentCloseFrameState: s, sendHints: c } = Xe(),
      {
        kWebSocketURL: l,
        kReadyState: d,
        kController: f,
      ...
      { establishWebSocketConnection: S, closeWebSocketConnection: C } = et(),
      { ByteParser: w } = nt(),
      { kEnumerableProperty: E, isBlobLike: D } = T(),
      { getGlobalDispatcher: O } = Te(),
      { types: k } = u(`node:util`),
      { ErrorEvent: A, CloseEvent: j } = Ye(),
      { SendQueue: M } = rt();
  ...
  ot = l((e, t) => {
    let { Transform: n } = u(`node:stream`),
      { isASCIINumber: r, isValidLastEventId: i } = at(),
      a = [239, 187, 191];
    t.exports = {
  ...
  st = l((e, t) => {
    let { pipeline: n } = u(`node:stream`),
      ...
      { makeRequest: i } = Pe(),
      { webidl: a } = z(),
      { EventSourceStream: o } = ot(),
      { parseMIMEType: s } = R(),
      { createFastMessageEvent: c } = Ye(),
      { isNetworkError: l } = Me(),
      { delay: d } = at(),
      { kEnumerableProperty: f } = T(),
      { environmentSettingsObject: p } = B(),
      m = !1,
      h = 3e3;
  ...
  ct = l((e, t) => {
    let n = G(),
      ...
      y = ge(),
      b = ce(),
      { getGlobalDispatcher: x, setGlobalDispatcher: C } = Te(),
      w = Ee(),
      E = W(),
      D = ie();
    (Object.assign(r.prototype, m),
      ...
      (t.exports.DecoratorHandler = w),
      (t.exports.RedirectHandler = E),
      (t.exports.createRedirectInterceptor = D),
      (t.exports.interceptors = { redirect: De(), retry: Oe(), dump: ke(), dns: Ae() }),
    ...
    ((t.exports.setGlobalDispatcher = C), (t.exports.getGlobalDispatcher = x));
    let A = Fe().fetch;
    ((t.exports.fetch = async function (e, t = void 0) {
      ...
      (t.exports.Headers = je().Headers),
      (t.exports.Response = Me().Response),
      (t.exports.Request = Pe().Request),
      (t.exports.FormData = te().FormData),
      (t.exports.File = globalThis.File ?? u(`node:buffer`).File),
      (t.exports.FileReader = Be().FileReader));
    let { setGlobalOrigin: M, getGlobalOrigin: N } = L();
    ((t.exports.setGlobalOrigin = M), (t.exports.getGlobalOrigin = N));
    let { CacheStorage: P } = We(),
      { kConstruct: F } = Ve();
    t.exports.caches = new P(F);
    let { deleteCookie: I, getCookies: z, getSetCookies: B, setCookie: ee } = Je();
    ((t.exports.deleteCookie = I),
      (t.exports.getCookies = z),
      (t.exports.getSetCookies = B),
      (t.exports.setCookie = ee));
    let { parseMIMEType: V, serializeAMimeType: H } = R();
    ((t.exports.parseMIMEType = V), (t.exports.serializeAMimeType = H));
    let { CloseEvent: ne, ErrorEvent: U, MessageEvent: re } = Ye();
    ((t.exports.WebSocket = it().WebSocket),
      (t.exports.CloseEvent = ne),
      (t.exports.ErrorEvent = U),
      (t.exports.MessageEvent = re),
      (t.exports.request = k(m.request)),
      (t.exports.stream = k(m.stream)),
      (t.exports.pipeline = k(m.pipeline)),
      (t.exports.connect = k(m.connect)),
      (t.exports.upgrade = k(m.upgrade)),
      (t.exports.MockClient = g),
      (t.exports.MockPool = v),
      (t.exports.MockAgent = _),
      (t.exports.mockErrors = y));
    let { EventSource: K } = st();
    t.exports.EventSource = K;
  });
(b(), ct());
var lt;
(function (e) {
...
const { access: pt, appendFile: mt, writeFile: ht } = c,
  gt = `GITHUB_STEP_SUMMARY`;
new (class {
  constructor() {
    this._buffer = ``;
  }
  filePath() {
    return ft(this, void 0, void 0, function* () {
      ...
      let e = process.env[gt];
      if (!e)
        throw Error(
          `Unable to find environment variable for $${gt}. Check if your runtime environment supports job summaries.`,
        );
      try {
        yield pt(e, s.R_OK | s.W_OK);
      } catch {
        throw Error(
  ...
  write(e) {
    return ft(this, void 0, void 0, function* () {
      ...
      return (yield (t ? ht : mt)(n, this._buffer, { encoding: `utf8` }), this.emptyBuffer());
    });
  }
  clear() {
    return ft(this, void 0, void 0, function* () {
...
(process.platform, a.constants.O_RDONLY, process.platform, n.platform(), n.arch());
var kt;
(function (e) {
  ((e[(e.Success = 0)] = `Success`), (e[(e.Failure = 1)] = `Failure`));
})((kt ||= {}));
function At(e, n) {
  if (process.env.GITHUB_OUTPUT) return _(`OUTPUT`, v(e, n));
  (process.stdout.write(t.EOL), p(`set-output`, { name: e }, d(n)));
}
function jt(e, t = {}) {
  p(`warning`, f(t), e instanceof Error ? e.toString() : e);
}
function Mt(e) {
...
function Nt() {
  try {
    if (o.existsSync(`.nvmrc`)) {
      let e = o.readFileSync(`.nvmrc`, `utf8`).trim();
      return (Mt(`Found .nvmrc: ${e}`), e);
    }
    if (o.existsSync(`package.json`)) {
      let e = JSON.parse(o.readFileSync(`package.json`, `utf8`));
      if (e.engines && e.engines.node)
        return (
          Mt(`Found Node.js version in package.json engines: ${e.engines.node}`), e.engines.node
        );
    }
  } catch (e) {
    jt(`Failed to detect Node.js version: ${e.message}`);
  }
  return `lts/*`;
}
function Pt() {
  try {
    if (o.existsSync(`pnpm-lock.yaml`)) return { name: `pnpm`, version: `latest` };
    if (o.existsSync(`yarn.lock`)) return { name: `yarn`, version: `latest` };
    if (o.existsSync(`package-lock.json`)) return { name: `npm`, version: `latest` };
    if (o.existsSync(`bun.lockb`) || o.existsSync(`bun.lock`))
    ...
    if (o.existsSync(`package.json`)) {
      ...
      if (e.packageManager) {
        ...
        return (
          Mt(`Found packageManager in package.json: ${t}@${n || `latest`}`),
          { name: t, version: n || `latest` }
        );
      }
    }
  } catch (e) {
    jt(`Failed to detect package manager: ${e.message}`);
  }
  return { name: `npm`, version: `latest` };
}
function Ft(e, t) {
  (At(`node_version`, e),
    At(`package_manager`, t.name),
    At(`package_manager_version`, t.version),
    Mt(`Detected values:
node_version=${e}
package_manager=${t.name}
package_manager_version=${t.version}`));
}
function It() {
  let e = Nt(),
    t = Pt();
  (Ft(e, t), Mt(`Final detection - Node: ${e}, PM: ${t.name}@${t.version}`));
}
It();
export { Nt as detectNodeVersion, Pt as detectPackageManager, It as run, Ft as writeOutput };
